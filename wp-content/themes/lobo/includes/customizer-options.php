...
function lobo_customizer( $wp_customize ) {

	class lobo_Customize_Textarea_Control extends WP_Customize_Control {
	...
	$wp_customize->remove_section( 'static_front_page');
	 ...
	 $wp_customize->add_section('nav_2', array(
		'title' => 'Menu Actions',
		'priority' => 15
	));
	 ...
	 /*
	 $wp_customize->add_section('lay', array(
		'title' => 'Layout',
		'priority' => 17
	));*/
	 ...
	 $wp_customize->add_section('nopage', array(
		'title' => '404',
		'priority' => 21
	));
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'lobo_logo_x2',
	        array(
	            'label' => 'Light logo (retina)',
	            'section' => 'sidebar',
	            'settings' => 'lobo_logo_x2',
	            'priority' => 3
	        )
	    )
	);
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'lobo_logo_x2_d',
	        array(
	            'label' => 'Dark logo (retina)',
	            'section' => 'sidebar',
	            'settings' => 'lobo_logo_x2_d',
	            'priority' => 4
	        )
	    )
	);
	...
	$wp_customize->add_setting(
		'lobo_logo_width', array(
			'default' => '77',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_logo_width', 
		array(
			'label' => 'Logo width',
			'section' => 'sidebar',
			'settings' => 'lobo_logo_width',
			'type' => 'text',
	        'priority' => 5
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_logo_height', array(
			'default' => '75',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_logo_height', 
		array(
			'label' => 'Logo height',
			'section' => 'sidebar',
			'settings' => 'lobo_logo_height',
			'type' => 'text',
	        'priority' => 6
		)
	);
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'lobo_loader',
	        array(
	            'label' => 'General Preloader',
	            'section' => 'preloader',
	            'settings' => 'lobo_loader'
	        )
	    )
	);
	...
	$wp_customize->add_control('lobo_compact_menu', 
		array(
			'label' => 'Menu type',
			'section' => 'nav',
			'settings' => 'lobo_compact_menu',
			'type' => 'select',
			'choices' => array(
				'compact-menu' => 'Big (right side)',
				'no-cmpt' => 'Small (on top)'
			)
		)
	);

	/* Complex Menu Background */

	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        $wp_customize,
	        'lobo_compact_menu_bg',
	        array(
	            'label' => 'Big menu background',
	            'section' => 'nav',
	            'settings' => 'lobo_compact_menu_bg'
	        )
	    )
	);
	...
	$wp_customize->add_control(
		new lobo_Customize_Textarea_Control(
			$wp_customize,
			'lobo_compact_menu_text', 
			array(
				'label' => 'Big menu text',
				'section' => 'nav',
				'settings' => 'lobo_compact_menu_text',
				'type' => 'textarea'
			)
		)
	);
	...
	$wp_customize->add_control('lobo_show_share', 
		array(
			'label' => 'Show Sharing',
			'section' => 'nav_2',
			'settings' => 'lobo_show_share',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show',
				'disabled' => 'Hide'
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'lobo_share_bg',
	        array(
	            'label' => 'Sharing Window Background',
	            'section' => 'nav_2',
	            'settings' => 'lobo_share_bg',
				'priority' => 21
	        )
	    )
	);
	...
	$wp_customize->add_control('lobo_show_fullscreen', 
		array(
			'label' => 'Show Fullscreen',
			'section' => 'nav_2',
			'settings' => 'lobo_show_fullscreen',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show',
				'disabled' => 'Hide'
	...
	$wp_customize->add_control('lobo_show_gotop', 
		array(
			'label' => 'Show "Go Top"',
			'section' => 'nav_2',
			'settings' => 'lobo_show_gotop',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show',
				'disabled' => 'Hide'
	...
	$wp_customize->add_control('lobo_show_search', 
		array(
			'label' => 'Show Search',
			'section' => 'nav_2',
			'settings' => 'lobo_show_search',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show',
				'disabled' => 'Hide'
	...
	$wp_customize->add_control('lobo_show_folio', 
		array(
			'label' => 'Show "Back to Portfolio"',
			'section' => 'nav_2',
			'settings' => 'lobo_show_folio',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show',
				'disabled' => 'Hide'
	...
	$wp_customize->add_setting(
		'lobo_layout_type', array(
			'default' => 'full',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_layout_type', 
		array(
			'label' => 'Layout type',
			'section' => 'lay',
			'settings' => 'lobo_layout_type',
			'type' => 'select',
			'choices' => array(
				'full' => 'Full Width',
				'boxed-layout' => 'Boxed'
	...
	$wp_customize->add_control('lobo_bg_type', 
		array(
			'label' => 'Boxed background type',
			'section' => 'lay',
			'settings' => 'lobo_bg_type',
			'type' => 'select',
			'choices' => array(
				'color' => 'Solid color',
				'img-full' => 'Full image',
				'img-repeat' => 'Repeating pattern'
			),
			'priority' => '2'
		)
	);
	...
	*/
	...
	$wp_customize->add_setting(
		'lobo_prlx_enable', array(
			'default' => 'parallax',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_prlx_enable', 
		array(
			'label' => 'Enable parallax',
			'section' => 'header',
			'settings' => 'lobo_prlx_enable',
			'type' => 'select',
			'choices' => array(
				'parallax' => 'Enable',
				'no-prlx' => 'Disable'
	...
	$wp_customize->add_setting(
		'lobo_sticky_enable', array(
			'default' => 'sticky-head',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_sticky_enable', 
		array(
			'label' => 'Enable sticky header',
			'section' => 'header',
			'settings' => 'lobo_sticky_enable',
			'type' => 'select',
			'choices' => array(
				'sticky-head' => 'Enable',
				'no-sticky-head actions-bottom' => 'Disable'
			),
			'priority' => 2
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_sticky_style', array(
			'default' => 'sticky-default',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_sticky_style', 
		array(
			'label' => 'Sticky header style',
			'section' => 'header',
			'settings' => 'lobo_sticky_style',
			'type' => 'select',
			'choices' => array(
				'sticky-default' => 'Default',
				'stroke-actions-enabled' => 'Text shadow',
				'enabled-sticky-shadow' => 'Solid background'
			),
			'priority' => 3
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_slider_loop', array(
			'default' => 'sldr-noloop',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_slider_loop', 
		array(
			'label' => 'Enable looping slider',
			'section' => 'header',
			'settings' => 'lobo_slider_loop',
			'type' => 'select',
			'choices' => array(
				'sldr-noloop' => 'Disable',
				'sldr-loop' => 'Enable'
	...
	$wp_customize->add_setting(
		'lobo_slider_fade', array(
			'default' => 'sldr-nofade',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_slider_fade', 
		array(
			'label' => 'Enable fading slider',
			'section' => 'header',
			'settings' => 'lobo_slider_fade',
			'type' => 'select',
			'choices' => array(
				'sldr-nofade' => 'Disable',
				'sldr-fade' => 'Enable'
	...
	$wp_customize->add_setting(
		'lobo_galleria_skin', array(
			'default' => 'skin-01',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_galleria_skin', 
		array(
			'label' => 'Gallery module skin',
			'section' => 'style',
			'settings' => 'lobo_galleria_skin',
			'type' => 'select',
			'choices' => array(
				'skin-01' => 'Skin #1',
				'skin-02' => 'Skin #2'
	...
	$wp_customize->add_setting(
		'lobo_footer_social', array(
			'default' => '[lobo_social twitter="#" facebook="#" behance="#" pinterest="#" gplus="#"]',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control(
		new lobo_Customize_Textarea_Control(
			...
			'lobo_footer_social', 
			array(
				'label' => 'Footer social area',
				'section' => 'footer',
				'settings' => 'lobo_footer_social',
				'type' => 'textarea'
			)
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_footer_copy', array(
			'default' => '<p>© We are Lobo. All rights reserved. 2014</p><p>Another row or whatever.</p>',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control(
		new lobo_Customize_Textarea_Control(
			...
			'lobo_footer_copy', 
			array(
				'label' => 'Footer text area',
				'section' => 'footer',
				'settings' => 'lobo_footer_copy',
				'type' => 'textarea'
			)
		)
	);
	...
	foreach($colorsArray as $color){
		...
		$wp_customize->add_setting(
			'lobo_colors[' . $color['setting'] . ']', array(
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				'lobo_colors[' . $color['setting'] . ']', array(
					'label' => $color['label'],
					'section' => 'colors',
					'settings' => 'lobo_colors[' . $color['setting'] . ']',
					'priority' => $i++
				)
			)
		);
	...
	$wp_customize->add_setting(
		'lobo_blog_cols', array(
			'default' => '3',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_blog_cols', 
		array(
			'label' => 'Blog columns',
			'section' => 'blog',
			'settings' => 'lobo_blog_cols',
			'type' => 'select',
			'choices' => array(
				'1' => 'One',
				'2' => 'Two',
	...
	$wp_customize->add_setting(
		'lobo_blog_page', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_blog_page', 
		array(
			'label' => 'Select default blog page',
			'section' => 'blog',
			'settings' => 'lobo_blog_page',
			'type' => 'dropdown-pages'
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_portfolio_page', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_portfolio_page', 
		array(
			'label' => 'Select default portfolio page',
			'section' => 'portfolio',
			'settings' => 'lobo_portfolio_page',
			'type' => 'dropdown-pages'
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_shop_cols', array(
			'default' => 'cols-2',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_shop_cols', 
		array(
			'label' => 'Shop columns',
			'section' => 'shop',
			'settings' => 'lobo_shop_cols',
			'type' => 'select',
			'choices' => array(
				'cols-2' => 'Two',
				'cols-3' => 'Three',
	...
	$wp_customize->add_control('lobo_shop_no', 
		array(
			'label' => 'Shop items per page',
			'section' => 'shop',
			'settings' => 'lobo_shop_no',
			'type' => 'text'
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_shop_cart', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_shop_cart', 
		array(
			'label' => 'Shopping cart',
			'section' => 'shop',
			'settings' => 'lobo_shop_cart',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show on entire site',
				'disabled' => 'Show only on shop related pages'
			)
		)
	);
	...
	$wp_customize->add_setting(
		'lobo_shop_sale', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('lobo_shop_sale', 
		array(
			'label' => 'Product sales icon',
			'section' => 'shop',
			'settings' => 'lobo_shop_sale',
			'type' => 'select',
			'choices' => array(
				'enabled' => 'Show',
				'disabled' => 'Hide'
	...
	$wp_customize->add_control('lobo_404_page', 
		array(
			'label' => 'Select default 404 page',
			'section' => 'nopage',
			'settings' => 'lobo_404_page',
			'type' => 'dropdown-pages'
		)
	);
	...
	$wp_customize->add_control('lobo_type_1', 
		array(
			'label' => 'Font #1',
			'section' => 'typography',
			'settings' => 'lobo_type_1',
			'type' => 'select',
	...
	$wp_customize->add_control('lobo_type_2', 
		array(
			'label' => 'Font #2',
			'section' => 'typography',
			'settings' => 'lobo_type_2',
			'type' => 'select',
			'choices' => $google_fonts_simple
		)
	);
	...
	$wp_customize->add_control('lobo_type_3', 
		array(
			'label' => 'Font #3',
			'section' => 'typography',
			'settings' => 'lobo_type_3',
			'type' => 'select',
			'choices' => $google_fonts_simple
		)
	);
	...
	$wp_customize->add_control('lobo_type_4', 
		array(
			'label' => 'Font #4',
			'section' => 'typography',
			'settings' => 'lobo_type_4',
			'type' => 'select',
			'choices' => $google_fonts_simple
		)
	);
...
add_action('customize_register', 'lobo_customizer');
